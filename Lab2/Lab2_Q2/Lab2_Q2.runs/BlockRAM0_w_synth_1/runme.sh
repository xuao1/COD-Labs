...
HD_PWD='D:/desktop/COD_Labs/Lab2/Lab2_Q2/Lab2_Q2.runs/BlockRAM0_w_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRAM0_w.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRAM0_w.tcl
