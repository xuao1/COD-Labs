...
namespace eval ::optrace {
  variable script "D:/desktop/COD_Labs/Lab2/Lab2_Q4_1/Lab2_Q3.runs/impl_1/RegFile.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/desktop/COD_Labs/Lab2/Lab2_Q4_1/Lab2_Q3.runs/synth_1/RegFile.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force RegFile_physopt.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi RegFile.mmi }
...
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force RegFile}
  catch {file copy -force RegFile.ltx debug_nets.ltx}
