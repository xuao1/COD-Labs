...
HD_PWD='D:/desktop/COD_Labs/Lab5/Lab5_q1/Lab5_q1.runs/instruction_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instruction.tcl
