...
HD_PWD='D:/desktop/COD_Labs/Lab4/Lab4_cpu - test/Lab4_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pdu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pdu.tcl -notrace
