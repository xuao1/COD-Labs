...
HD_PWD='D:/desktop/COD_Labs/Lab4/Lab4_cpu - test/Lab4_cpu.runs/instrcution_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instrcution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instrcution.tcl
