...
HD_PWD='D:/desktop/COD_Labs/Lab4/Lab4_cpu - sort/Lab4_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pdu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pdu.tcl
