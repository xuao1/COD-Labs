...
HD_PWD='D:/desktop/COD_Labs/Lab1/Lab1_32bitsALU/Lab1_32bitsALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topv.tcl
