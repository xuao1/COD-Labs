...
HD_PWD='D:/desktop/COD_Labs/Lab1/Lab1_32bitsALU/Lab1_32bitsALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topv.tcl -notrace
